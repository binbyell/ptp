...
class DrawingPainter04 extends CustomPainter{
  DrawingPainter04({required List<List<DotInfo04>> lines, this.recentImage}):lines=lines;
  final List<List<DotInfo04>> lines;
  ...
  void paint(Canvas canvas, Size size) async{
    ...
    for(var oneLine in lines){
      ...
      // );
      Offset? recentPoint;
      for(DotInfo04 oneDot in oneLine){
        if(recentPoint == null){
